...
namespace Prosol.Core.Interface
{
    ...
    public partial class BomService : I_Bom
    {
        ...
        public List<Prosol_Datamaster> frstmat()
        {
            ...
            var Result = _DatamasterRepository.FindAll().ToList();
            return Result;
        ...
        {
            var qry = Query.And(Query.EQ("Itemcode", BsonRegularExpression.Create(new Regex(term.TrimStart().TrimEnd()))));
        ...
        {
            var qry = Query.EQ("FunctLocation", id);
