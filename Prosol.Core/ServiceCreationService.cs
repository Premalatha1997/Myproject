...
namespace Prosol.Core
{
    ...
    public partial class ServiceCreationService : IServiceCreation
    {
                                       ...
                                       IRepository<Prosol_Abbrevate> abbreivateRepository,
                                        IRepository<Prosol_Attribute> attributeRepository,
                                             ...
                                             IRepository<Prosol_Servicecodelogic> ServicecodelogicRepository,
                                              IRepository<Prosol_ServiceDefaultAttr> ServiceDefaultatt)
                                      //IRepository<Prosol_Attribute> attributeRepository,
                                  //  IRepository<Prosol_Abbrevate> abbreivateRepository,
        ...
        {
           var query = Query.And(Query.EQ("Cleanserr.UserId", Cleanser), Query.Or(Query.EQ("ServiceStatus", "Cleanse"), Query.EQ("ServiceStatus", "Cleansed")));
        ...
        public bool AddValue1(string SubCode, string Attribute, string Value, string abb)
        {
            ...
            if (obj != null )
            {
                ...
                //}
                var Qry1 = Query.And(Query.EQ("Activity", SubCode), Query.EQ("Attributes", Attribute));
                var TemplateMaster = _CharacteristicRepository.FindOne(Qry1);
