    ...
    public partial class ServiceMasterService : IServiceMaster
    {
     ...
     //   private readonly IRepository<Prosol_SMainSubs> _ServiceMasterMNRepository;
       ...
       public bool DelSubSubcode(string id)
        ...
        {
            var thilagavathy = Query.EQ("Activity", data[0].Activity);
            var result = _ServiceMasterMSAttRepository.FindAll(thilagavathy).ToList();
        ...
        public bool insert_multiplerequest1(List<Prosol_RequestService> request, string reqid)
        {
            ...
            foreach (Prosol_RequestService pr1 in request)
            {
                ...
                pr1.ServiceStatus = "Cleanse";
                pr1.RequestStatus = "Cleanse";
        ...
        //}
        public List<string> GetValues(string SubCode, string Attribute)
        {
            ...
            if (Attribute != null)
            {
                ...
                var query = Query.And(Query.EQ("Activity", SubCode), Query.EQ("Attributes", Attribute));
