...
namespace ProsolOnline.Controllers
{
    public class ServiceMasterController : Controller
    {
        ...
        {
            //mainsub
            var actvity = Request.Form["Activity"];
          
            //var Model = JsonConvert.DeserializeObject<MS_Attribute>(obj);
            //Prosol_SSubCode mdl = new Prosol_SSubCode();
            //mdl.MainCode = Model.MainCode;
            //mdl.MainDiscription = Model.MainDiscription;
            //mdl.SubCode = Model.SubCode;
            //mdl.SubDiscription = Model.SubDiscription;
    ...
    //    }
        ...
        public JsonResult GetValues(string SubCode, string Attribute)
        {
            var arrStr = _ServiceMasterService.GetValues( SubCode, Attribute).ToList();
        ...
        //checkvalue
        public string CheckValue(string MainCode, string SubCode, string Attribute, string Value)
        {
            var res = _ServiceCreationService.CheckValue(MainCode, SubCode, Attribute, Value);

            return res;
        }
        //addvalue
        public bool AddValue1(string SubCode, string Attribute, string Value, string abb)
        {
            var res = _ServiceCreationService.AddValue1(SubCode, Attribute, Value, abb);
