...
namespace ProsolOnline.Controllers
{
    public class BomController : Controller
    {
        ...
        [Authorize]
        public JsonResult funlocsearch(string sKey)
        {
            ...
            var jsonResult = Json(lstfunloc1, JsonRequestBehavior.AllowGet);
        ...
        [Authorize]
        public JsonResult funlocsearch1()
        {
            ...
            var srch = _BomService.funlocsearch1();
            var lstfunloc = new List<Prosol_Funloc>();
            foreach (Prosol_Funloc fun in srch)
            {
                var pro = new Prosol_Funloc();
        ...
        [Authorize]
        public JsonResult funlocsearchb()
        {
        ...
        public JsonResult funlocsearc4()
        {
            var srch = _BomService.funlocsearch2();
        ...
        [Authorize]
        public JsonResult searching1(string sKey)
        {
            var srchList = _SearchService.SearchDesc(sKey, "Description");
            if (srchList.Count == 0)
            {
